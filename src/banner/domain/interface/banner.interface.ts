...
export interface BannerRepositoryInterface{
    ...
    updateBannerBy(condition: Partial<Banner>, data: Partial<Banner>, transaction?: unknown): Promise<boolean>;
    deleteBanner(condition: Partial<Banner>, transaction?: unknown): Promise<boolean>;
    ...
    findBannerByExceptId(condition: Partial<Banner>, id: number): Promise<Banner | null>;
